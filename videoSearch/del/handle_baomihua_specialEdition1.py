...
p_vid = re.compile('http://video.baomihua.com/url\d+/(\d+)_p=\d+')
...
if __name__ == '__main__':
    #pprint.pprint(handle('http://app.baomihua.com/u/1346',100120))
    pprint.pprint(handle('http://app.baomihua.com/u/1772',100119))
