...
def handle(url, channelId, tvNumber):
    ...
    videos = tree.xpath('//div[@class="mainbox"]/ul/li/span/a')
    ret = []
    for video in videos:
        try:
            url = "http://g.tingcd.com/" + video.xpath('./@href')[0]
...
if __name__ == '__main__':
    pprint.pprint(handle('http://g.tingcd.com/xiangsheng.html', 100128, 1))
